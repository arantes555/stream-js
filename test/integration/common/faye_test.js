...
describe('[INTEGRATION] Stream client (Faye)', function () {
  ...
  it('fayeSubscribeListeningWrongToken', function (done) {
    // Invalid token:
    const testUser1 = this.client.feed('user', '111', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyZXNvdXJjZSI6IioiLCJhY3Rpb24iOiIqIiwiZmVlZF9pZCI6InVzZXIyMjIifQ.WXZTbUgxfitUVwJOhRKu9HRnpf-Je8AwA5BmiUG6vYY')
    // Valid token:
    const testUser2 = this.user2
